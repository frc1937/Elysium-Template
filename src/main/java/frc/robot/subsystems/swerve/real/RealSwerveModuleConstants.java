...
public class RealSwerveModuleConstants {
    ...
    private static final CANcoder
            FRONT_LEFT_STEER_ENCODER = new CANcoder(FRONT_LEFT_DRIVE_MOTOR_ID),
            FRONT_RIGHT_STEER_ENCODER = new CANcoder(FRONT_RIGHT_DRIVE_MOTOR_ID),
            REAR_LEFT_STEER_ENCODER = new CANcoder(REAR_LEFT_DRIVE_MOTOR_ID),
            REAR_RIGHT_STEER_ENCODER = new CANcoder(REAR_RIGHT_DRIVE_MOTOR_ID);

    static final RealSwerveModuleConstants
            FRONT_LEFT_SWERVE_MODULE_CONSTANTS = new RealSwerveModuleConstants(
            FRONT_LEFT_DRIVE_MOTOR,
            FRONT_LEFT_STEER_MOTOR,
            FRONT_LEFT_STEER_ENCODER,
            FRONT_LEFT_STEER_ENCODER_OFFSET
    ),
            FRONT_RIGHT_SWERVE_MODULE_CONSTANTS = new RealSwerveModuleConstants(
                    FRONT_RIGHT_DRIVE_MOTOR,
                    FRONT_RIGHT_STEER_MOTOR,
                    FRONT_RIGHT_STEER_ENCODER,
                    FRONT_RIGHT_STEER_ENCODER_OFFSET
            ),
            REAR_LEFT_SWERVE_MODULE_CONSTANTS = new RealSwerveModuleConstants(
                    REAR_LEFT_DRIVE_MOTOR,
                    REAR_LEFT_STEER_MOTOR,
                    REAR_LEFT_STEER_ENCODER,
                    REAR_LEFT_STEER_ENCODER_OFFSET
            ),
            REAR_RIGHT_SWERVE_MODULE_CONSTANTS = new RealSwerveModuleConstants(
    ...
    private RealSwerveModuleConstants(TalonFX driveMotor, TalonFX steerMotor, CANcoder steerEncoder, double encoderOffset) {
